...
| 2 (storage done in 0.5) | Real networking: nodes as processes, gossip over sockets. Durable block store exists | Four nodes on four machines finalise blocks; one is killed and rejoins from its store |
